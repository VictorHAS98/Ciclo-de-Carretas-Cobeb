...
-- Script: 034 — Fix painel admin total ver todas as unidades
-- Executar no Supabase Studio > SQL Editor
-- ================================================================

-- Admin total (acesso_total = true) enxerga viagens de todas as unidades.
-- Operador de empilhadeira continua vendo apenas sua unidade.
