  ...
  return (
    <div className="px-5 py-4">
      <div className="flex items-center justify-between mb-4">
        <div>
          <p className="text-white font-semibold text-sm">{lista.length} cavalo{lista.length !== 1 ? 's' : ''}</p>
      ...
      {loading ? (
        ...
        <p className="text-center text-slate-600 text-sm py-12">Nenhum cavalo encontrado</p>
      ) : (
